<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"K:\workspace\MrShip\public/../application/index\view\admin\index.html";i:1487472668;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>MrShip_admin</title>
    ...
    <div class="row col-lg-12" style="padding-top: 60px">
        <div class="col-lg-12">
            ...
            <form action="/index/Admin/imageUpload" method="post">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <input class="form-control" type="text" name="introduce" placeholder="介绍"/>
                </div>
                <!-- 加载编辑器的容器 -->
                <script id="container" name="content" type="text/plain" class="col-lg-12" style="padding-top:30px">
